<x-app-layout>
    ...
    <div class="mb-8" style="font-family: 'Inter', sans-serif;">
        ...
        <p class="mt-1 text-gray-600 text-sm" style="font-family: 'Roboto', sans-serif;">
            Visualize, pesquise e gerencie todas as turmas da paróquia.
        </p>
    </div>
    ...
    <div class="mb-6 relative w-full md:w-1/2 lg:w-1/3" style="font-family: 'Roboto', sans-serif;">
        ...
        <input type="text" id="pesquisarTurma" placeholder="Pesquisar Turma..."
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden" style="font-family: 'Roboto', sans-serif;">
        <div class="overflow-x-auto" style="width: 100%;">
            ...
            <table style="width: 100%; border-collapse: collapse; text-align: left;">
                ...
                <tr>
                    <th scope="col" style="width: 50%; padding: 1rem 1.5rem; font-size: 0.75rem; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em; text-align: left;">
                        Nome da Turma
                    </th>
                    ...
                    <th scope="col" style="width: 25%; padding: 1rem 1.5rem; font-size: 0.75rem; font-weight: 600; color: #6b7280; text-transform: uppercase; letter-spacing: 0.05em; text-align: center;">
                        Ações
                    </th>
                </tr>
                </thead>
                ...
                @forelse ($turmas as $turma)
                    <tr class="hover:bg-gray-50 transition-colors duration-150" style="border-bottom: 1px solid #e5e7eb;">
                        ...
                        <td style="padding: 1rem 1.5rem; text-align: left; white-space: nowrap;">
                            <div style="font-weight: 700; color: #111827; font-size: 1rem; margin-bottom: 0.125rem;">
                                {{ $turma->nome_turma ?? 'Sem Nome' }}
                            </div>
                        </td>

                        <td style="padding: 1rem 1.5rem; text-align: left; white-space: nowrap; color: #374151; font-weight: 500;">
                            {{ $turma->catequista->name ?? 'Não atribuído' }}
                        </td>

                        <td style="padding: 1rem 1.5rem; white-space: nowrap;">
                            <div style="display: flex; justify-content: center; gap: 0.75rem;">
                                <a href="{{ route('coordenadora.editarTurma', $turma) }}" title="Editar" class="text-blue-500 hover:text-blue-700 transition-colors p-1 rounded hover:bg-blue-50">
                                    <i class="material-icons-outlined">edit</i>
                                </a>

                                <form action="{{ route('coordenadora.deleteTurma', $turma) }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir esta turma?');" style="display: inline;">
                                    @csrf
                                    @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="3" style="padding: 3rem 1.5rem; text-align: center; color: #6b7280;">
                            <i class="material-icons text-4xl mb-2 text-gray-300">group_off</i>
                            <p style="font-size: 1.125rem; margin: 0;">Nenhuma turma cadastrada no momento.</p>
                        </td>
                    </tr>
                @endforelse
